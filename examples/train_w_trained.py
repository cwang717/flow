...
def setup_exps_rllib(flow_params,
    ...
    # for original wave ones
    # config["vf_clip_param"] = 60 

    # for ring disguised attacker
    # sota for single agent w/ trained
    #config["vf_clip_param"] = 40

    config["vf_clip_param"] = flags.vf
