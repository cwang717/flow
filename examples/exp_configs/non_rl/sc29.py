...
from flow.envs.highway_ramps_env_zov import HighwayRampsZOVEnv
...
vehicles.add(
    ...
    car_following_params=SumoCarFollowingParams(
        ...
        decel=8,
        sigma=0.1,
        tau=1,  # larger distance between cars        
        max_speed=40,
    ),
    lane_change_params=SumoLaneChangeParams(
        lane_change_mode=1621,
...
additional_net_params["next_off_ramp_proba"] = 0.08
...
flow_params = dict(
    ...
    sim=SumoParams(
        render=False,
        emission_path="/home/cwang717/git/flow/output/crystal_v2/sc29",
        sim_step=0.1,
