...
class TrainedSingleRingController(BaseController):
    def __init__(self,
                 veh_id, 
                 car_following_params,
                 delay=0, 
        ...
        new_saver = tf.train.import_meta_graph('/home/cwang717/tensorflow/single_ring/model.meta')
        new_saver.restore(self.sess, tf.train.latest_checkpoint('/home/cwang717/tensorflow/single_ring/'))
...
class TrainedMinicityController(BaseController):
    def __init__(self,
                 veh_id, 
                 car_following_params,
                 delay=0, 
