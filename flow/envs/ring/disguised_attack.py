...
class DisguisedAttackEnv(Env):
    ...
    * ring_length: bounds on the ranges of ring road lengths the autonomous
    ...
    Rewards
        ...
        the network, and rewards similar accelerations with IDM model by the rl vehicle.
...
class DisguisedAttackPOEnv(DisguisedAttackEnv):
